...
var dialoguePart = 0
var texts = [ "", 
	"Here was the first place of the earthquake caused by the movement of the MPJ-1.",
	"Here used to be the home of the main product model leaders… now it is totally destroyed and with marks on the ground."
	]
